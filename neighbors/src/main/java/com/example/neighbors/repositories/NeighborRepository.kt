...
class NeighborRepository private constructor(private val application: Application) {
    ...
    fun add(neighbor: Neighbor) = executor.execute{dataSource.createNeighbor(neighbor)}
    fun delete(neighbor: Neighbor) =  executor.execute{dataSource.deleteNeighbor(neighbor)}
